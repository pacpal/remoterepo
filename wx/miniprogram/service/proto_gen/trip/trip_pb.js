...
export const coolcar = $root.coolcar = (() => {
     ...
     * @name coolcar.Status
     * @enum {number}
     * @property {number} NO_REPLY=0 NO_REPLY value
     * @property {number} CONNECTED=1 CONNECTED value
     * @property {number} CONNECTING=2 CONNECTING value
     * @property {number} OVER=3 OVER value
     */
    coolcar.Status = (function() {
        const valuesById = {}, values = Object.create(valuesById);
        values[valuesById[0] = "NO_REPLY"] = 0;
        values[valuesById[1] = "CONNECTED"] = 1;
        values[valuesById[2] = "CONNECTING"] = 2;
        values[valuesById[3] = "OVER"] = 3;
        return values;
    })();
    ...
    coolcar.Trip = (function() {
         ...
         * @instance
         */
        Trip.prototype.durationSec = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
         ...
         * @instance
         */
        Trip.prototype.feeCent = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

        /**
         * Trip status.
         * @member {coolcar.Status} status
         * @memberof coolcar.Trip
         * @instance
         */
        ...
        Trip.verify = function verify(message) {
            ...
            if (message.durationSec != null && message.hasOwnProperty("durationSec"))
                if (!$util.isInteger(message.durationSec) && !(message.durationSec && $util.isInteger(message.durationSec.low) && $util.isInteger(message.durationSec.high)))
                    return "durationSec: integer|Long expected";
            if (message.feeCent != null && message.hasOwnProperty("feeCent"))
                if (!$util.isInteger(message.feeCent) && !(message.feeCent && $util.isInteger(message.feeCent.low) && $util.isInteger(message.feeCent.high)))
                    return "feeCent: integer|Long expected";
        ...
        Trip.fromObject = function fromObject(object) {
            ...
            if (object.durationSec != null)
                if ($util.Long)
                    (message.durationSec = $util.Long.fromValue(object.durationSec)).unsigned = false;
                else if (typeof object.durationSec === "string")
                    message.durationSec = parseInt(object.durationSec, 10);
                else if (typeof object.durationSec === "number")
                    message.durationSec = object.durationSec;
                else if (typeof object.durationSec === "object")
                    message.durationSec = new $util.LongBits(object.durationSec.low >>> 0, object.durationSec.high >>> 0).toNumber();
            if (object.feeCent != null)
                if ($util.Long)
                    (message.feeCent = $util.Long.fromValue(object.feeCent)).unsigned = false;
                else if (typeof object.feeCent === "string")
                    message.feeCent = parseInt(object.feeCent, 10);
                else if (typeof object.feeCent === "number")
                    message.feeCent = object.feeCent;
                else if (typeof object.feeCent === "object")
                    message.feeCent = new $util.LongBits(object.feeCent.low >>> 0, object.feeCent.high >>> 0).toNumber();
        ...
        Trip.toObject = function toObject(message, options) {
            ...
            if (options.defaults) {
                ...
                if ($util.Long) {
                    ...
                    object.durationSec = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                } else
                    object.durationSec = options.longs === String ? "0" : 0;
                if ($util.Long) {
                    let long = new $util.Long(0, 0, false);
                    object.feeCent = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                } else
                    object.feeCent = options.longs === String ? "0" : 0;
                object.startPos = null;
                object.endPos = null;
                object.status = options.enums === String ? "NO_REPLY" : 0;
            }
            if (message.start != null && message.hasOwnProperty("start"))
            ...
            if (message.durationSec != null && message.hasOwnProperty("durationSec"))
                if (typeof message.durationSec === "number")
                    object.durationSec = options.longs === String ? String(message.durationSec) : message.durationSec;
                else
                    object.durationSec = options.longs === String ? $util.Long.prototype.toString.call(message.durationSec) : options.longs === Number ? new $util.LongBits(message.durationSec.low >>> 0, message.durationSec.high >>> 0).toNumber() : message.durationSec;
            if (message.feeCent != null && message.hasOwnProperty("feeCent"))
                if (typeof message.feeCent === "number")
                    object.feeCent = options.longs === String ? String(message.feeCent) : message.feeCent;
                else
                    object.feeCent = options.longs === String ? $util.Long.prototype.toString.call(message.feeCent) : options.longs === Number ? new $util.LongBits(message.feeCent.low >>> 0, message.feeCent.high >>> 0).toNumber() : message.feeCent;
            if (message.startPos != null && message.hasOwnProperty("startPos"))
            ...
            if (message.status != null && message.hasOwnProperty("status"))
                object.status = options.enums === String ? $root.coolcar.Status[message.status] : message.status;
            return object;
        };
